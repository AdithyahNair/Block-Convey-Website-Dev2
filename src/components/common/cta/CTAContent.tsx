...
export const CTAContent: React.FC = () => {
  ...
  const titleText = "Ready to try AI Governance?";
  ...
  return (
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Grid pattern */}
        <div className="absolute inset-0 bg-[linear-gradient(rgba(94,163,163,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(94,163,163,0.05)_1px,transparent_1px)]" style={{ backgroundSize: '30px 30px' }} />
      ...
      >
        ...
        >
          ...
          >
            Experience the future of AI management with our comprehensive blockchain-powered platform
          </motion.p>
            ...
            <div className="absolute inset-0 opacity-10">
              <svg width="100%" height="100%">
                <pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse">
                  <path d="M 40 0 L 0 0 0 40" fill="none" stroke="rgba(94,163,163,0.2)" strokeWidth="1" />
                </pattern>
                  ...
                  {[80, 65, 90, 70].map((value, i) => (
                    ...
                    >
                      <div className="text-xs text-gray-500 mb-1">
                        {["Risk Score", "Compliance", "Transparency", "Performance"][i]}
                      </div>

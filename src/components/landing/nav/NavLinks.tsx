    ...
    items: [
      {
        ...
        description: "Get (and stay) compliant with ease.",
      },
      {
        title: "Vendor Risk Management",
        description: "Streamline vendor security reviews.",
      },
      {
        title: "Questionnaire Automation",
        description: "Auto-fill security questionnaires.",
      },
      ...
      { title: "Continuous GRC", description: "Join the modern way to GRC." },
      {
        ...
        description: "Simplify audits from start to finish.",
      },
      {
        title: "Risk Management",
        description: "Centralize risk, stay informed.",
      },
      {
        title: "Personnel and Access",
        description: "Manage compliance across employees.",
      },
    ],
  },
  {
    ...
    items: [
      {
        title: "Trust management platform",
        description: "Deepen your security—and customer trust.",
      },
      { title: "Vanta Integrations", description: "Sync with 375+ tools." },
      {
        title: "Vanta AI ✨",
        description: "Hand off your most tedious tasks.",
      },
      {
        title: "Vanta API",
        description: "Enhance your security and compliance automation.",
      },
    ],
  },
  {
      ...
      {items.map((item, idx) => (
        ...
        >
          <button
            ...
            className={`flex items-center py-2 px-2 text-gray-700 hover:text-purple-700 focus:outline-none font-medium transition-colors ${

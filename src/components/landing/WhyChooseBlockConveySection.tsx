        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <div className="overflow-x-auto px-2 sm:px-0">
              ...
              <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 min-w-[700px] lg:w-[130%] lg:transform lg:scale-80 lg:origin-top-left lg:-ml-24 lg:mr-4">
                {/* Browser-like header */}

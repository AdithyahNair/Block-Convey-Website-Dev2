  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
        Explore Insights on Explainable AI, and Governance in Finance
      </h1>
      <p className="text-xl text-gray-600 mb-8">
        Discover expert insights, tools, and content to navigate AI in the
        financial industry while mastering AI governance.
      </p>
      <p className="text-lg text-gray-600">
        ...
        implement and maintain robust AI governance.
      </p>
    </motion.div>
  );
};

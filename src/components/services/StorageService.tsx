...
const features = [
  {
    ...
    description: "Easily scale your storage needs as your data grows, with no performance impact"
  },
  {
    icon: Shield,
    title: "Blockchain Security",
    description: "Enterprise-grade encryption with immutable blockchain verification"
  },
  {
    icon: Lock,
...
export const StorageService: React.FC = () => {
  return (
    <section id="storage" className="relative pt-32 pb-16 overflow-hidden bg-gradient-to-b from-brand-lightest to-white">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-8">
            Block Convey's decentralized storage solutions ensure your data is secure, 
            scalable, and easily accessible. Built on blockchain technology, our storage 
            platform is designed for the modern enterprise seeking efficiency and security.
          </p>
          <div className="flex flex-wrap gap-4">
            ...
            <button className="inline-flex items-center gap-2 bg-brand-light/20 text-gray-900 border border-brand-light px-8 py-4 rounded-xl font-medium hover:bg-brand-light/30 transition-colors">
              Book a Demo
            </button>
          </div>
        </motion.div>

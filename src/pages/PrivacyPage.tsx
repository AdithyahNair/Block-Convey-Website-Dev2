      ...
      <div id="hero" className="min-h-screen bg-white">
        <main className="max-w-4xl mx-auto px-4 py-32">
          ...
          <div className="text-lg space-y-8 mb-16 text-gray-600">
            <p>
              Welcome to Block Convey! Your privacy is important to us, and we
              are committed to protecting your personal data. This Privacy
              Policy outlines how Block Convey, Inc ("Block Convey," "we," "us,"
              or "our") collects, uses, shares, and protects your information
              when you access or use our website, applications, and services
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      ...
                      details, and account credentials when you create an
                      account.
                    </li>
                    <li>
                      <span className="font-medium">Content:</span> Any data you
                      upload, such as files, images, or prompts submitted
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      ...
                      how you interact with our Services, such as the features
                      you use, time spent, and pages visited.
                    </li>
                    <li>
              ...
              <div className="text-gray-600 space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    ...
                    vendors who assist in providing hosting, analytics,
            ...
            <section>
              ...
              <div className="text-gray-600 space-y-4">
                <p>
                  ...
                  your information. However, no system is entirely secure.
                  Please take precautions to safeguard your credentials and
                  personal data.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-gray-600 space-y-4">
                <p>
                  ...
                  browsing experience and personalize content. You can manage
            ...
            <section>
              ...
              <div className="text-gray-600 space-y-4">
                <p>
                  ...
                  through the Services. The updated policy will be effective as
                  of the date posted.
                </p>
              </div>
            </section>

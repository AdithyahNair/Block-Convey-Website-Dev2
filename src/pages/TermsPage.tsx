      ...
      <div id="hero" className="min-h-screen bg-white">
        <main className="max-w-4xl mx-auto px-4 py-32">
          ...
          <div className="mb-16">
            ...
            <h1 className="text-7xl text-gray-900 mb-16">Terms of Service</h1>
          </div>
          ...
          <div className="text-lg space-y-8 mb-16 text-gray-600">
            <p>
              ...
              your access to and use of Block Convey's website, products, and
          ...
          <div className="space-y-16">
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>
                      ...
                      including bypassing security measures or
            ...
            <section>
              ...
              <div className="text-gray-600 space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <span className="font-medium">Modifications:</span> We
                    reserve the right to update, modify, or discontinue the
                    Services at any time without prior notice.
                  </li>
                  <li>
                    <span className="font-medium">Third-Party Services:</span>{" "}
                    The Services may integrate with third-party applications or
                    platforms, which are governed by their own terms and
                    policies.
                  </li>
                </ul>
              </div>
            ...
            <section>
              ...
              <div className="text-gray-600 space-y-4">
                <p>
                  ...
                  By using the Services, you consent to our data practices.
                </p>
              </div>
            </section>
              ...
              <div className="text-gray-600 space-y-4">
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    ...
                    Services for any violation of these Terms or other
                    misconduct.
                  </li>
                  <li>
            ...
            <section>
              ...
              <div className="text-gray-600 space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    Block Convey shall not be liable for indirect, incidental,

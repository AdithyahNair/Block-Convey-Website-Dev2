...
async function getBlogBySlug(slug) {
    try {
        const blogsQuery = query(collection(db, "blogs"), where("slug", "==", slug), where("published", "==", true));
...
const defaultMeta = {
    ...
    description: "Block Convey helps organizations achieve AI compliance through automated governance, risk management, and regulatory compliance solutions.",
...
const pageMeta = {
    ...
    "/solutions": {
        ...
        description: "Discover our comprehensive AI compliance solutions for automated governance, risk management, and regulatory compliance.",
    ...
    "/who-we-serve": {
        ...
        description: "Tailored AI compliance solutions for financial institutions, fintech startups, and insurtech companies.",
    ...
    "/prism": {
        ...
        description: "PRISM: The comprehensive AI governance platform for transparent, compliant, and ethical AI systems.",
    ...
    "/resources": {
        ...
        description: "Expert resources, insights, and tools for AI governance and compliance.",
        image: "https://blockconvey.com/images/business-value.png",
...
expressApp.get("/_ah/health", (req, res) => {
